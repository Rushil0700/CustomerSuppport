---
id: troubleshooting-upload-fails-macos
title: Uploads fail part-way through (the macOS desktop app)
category: troubleshooting
tags: [files, macos, network, upload]
audience: customer
severity: normal
---

# Uploads fail part-way through (the macOS desktop app)
