---
id: integration-google-workspace-limits
title: Google Workspace integration: sync behaviour and limits
category: integrations
tags: [google-workspace, integration, limits, sync]
audience: customer
severity: normal
---

# Google Workspace integration: sync behaviour and limits
...
Google Workspace enforces its own API limits. When we are throttled the integration backs
