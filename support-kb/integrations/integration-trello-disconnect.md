---
id: integration-trello-disconnect
title: Disconnect Trello and remove its data
category: integrations
tags: [integration, privacy, removal, trello]
audience: customer
severity: normal
---

# Disconnect Trello and remove its data

## Steps

1. Settings > **Integrations** > Trello > **Disconnect**.
2. Confirm. The OAuth token is revoked immediately on our side.
3. Also remove the Acme Cloud app from within Trello; revoking on one side alone
