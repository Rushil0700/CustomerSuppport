---
id: troubleshooting-permission-denied-macos
title: 'You do not have permission' on a file you should own (the macOS desktop app)
category: troubleshooting
tags: [access, macos, permissions, roles]
audience: customer
severity: normal
---

# 'You do not have permission' on a file you should own (the macOS desktop app)
