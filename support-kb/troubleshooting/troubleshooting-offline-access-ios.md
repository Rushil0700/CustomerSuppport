---
id: troubleshooting-offline-access-ios
title: Access files without a connection (the iOS app)
category: troubleshooting
tags: [ios, mobile, offline, sync]
audience: customer
severity: normal
---

# Access files without a connection (the iOS app)
