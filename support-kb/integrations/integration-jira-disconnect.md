---
id: integration-jira-disconnect
title: Disconnect Jira and remove its data
category: integrations
tags: [integration, jira, privacy, removal]
audience: customer
severity: normal
---

# Disconnect Jira and remove its data

## Steps

1. Settings > **Integrations** > Jira > **Disconnect**.
2. Confirm. The OAuth token is revoked immediately on our side.
3. Also remove the Acme Cloud app from within Jira; revoking on one side alone
