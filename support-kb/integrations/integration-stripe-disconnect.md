---
id: integration-stripe-disconnect
title: Disconnect Stripe and remove its data
category: integrations
tags: [integration, privacy, removal, stripe]
audience: customer
severity: normal
---

# Disconnect Stripe and remove its data

## Steps

1. Settings > **Integrations** > Stripe > **Disconnect**.
2. Confirm. The OAuth token is revoked immediately on our side.
3. Also remove the Acme Cloud app from within Stripe; revoking on one side alone
