---
id: integration-google-drive-connect
title: Connect Google Drive to Acme Cloud
category: integrations
tags: [google-drive, integration, setup]
audience: customer
severity: normal
---

# Connect Google Drive to Acme Cloud

## Before you start

You need the **admin** role in the Acme Cloud workspace, and permission to
install apps in Google Drive. On the Free plan integrations are limited to one; Team
and above are unlimited.

## Steps

1. Settings > **Integrations** and find Google Drive.
2. Choose **Connect**. You are redirected to Google Drive to authorise access.
...
Escalate if the authorisation redirect returns an error from Google Drive, or if the
