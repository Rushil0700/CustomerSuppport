---
id: integration-jira-limits
title: Jira integration: sync behaviour and limits
category: integrations
tags: [integration, jira, limits, sync]
audience: customer
severity: normal
---

# Jira integration: sync behaviour and limits
...
Jira enforces its own API limits. When we are throttled the integration backs
