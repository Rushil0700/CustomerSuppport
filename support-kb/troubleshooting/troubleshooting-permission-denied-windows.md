---
id: troubleshooting-permission-denied-windows
title: 'You do not have permission' on a file you should own (the Windows desktop app)
category: troubleshooting
tags: [access, permissions, roles, windows]
audience: customer
severity: normal
---

# 'You do not have permission' on a file you should own (the Windows desktop app)
