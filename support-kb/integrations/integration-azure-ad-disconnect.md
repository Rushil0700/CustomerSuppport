---
id: integration-azure-ad-disconnect
title: Disconnect Microsoft Entra ID and remove its data
category: integrations
tags: [azure-ad, integration, privacy, removal]
audience: customer
severity: normal
---

# Disconnect Microsoft Entra ID and remove its data

## Steps

1. Settings > **Integrations** > Microsoft Entra ID > **Disconnect**.
2. Confirm. The OAuth token is revoked immediately on our side.
3. Also remove the Acme Cloud app from within Microsoft Entra ID; revoking on one side alone
