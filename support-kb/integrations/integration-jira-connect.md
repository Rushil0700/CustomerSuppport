---
id: integration-jira-connect
title: Connect Jira to Acme Cloud
category: integrations
tags: [integration, jira, setup]
audience: customer
severity: normal
---

# Connect Jira to Acme Cloud

## Before you start

You need the **admin** role in the Acme Cloud workspace, and permission to
install apps in Jira. On the Free plan integrations are limited to one; Team
and above are unlimited.

## Steps

1. Settings > **Integrations** and find Jira.
2. Choose **Connect**. You are redirected to Jira to authorise access.
...
Escalate if the authorisation redirect returns an error from Jira, or if the
