---
id: integration-azure-ad-connect
title: Connect Microsoft Entra ID to Acme Cloud
category: integrations
tags: [azure-ad, integration, setup]
audience: customer
severity: normal
---

# Connect Microsoft Entra ID to Acme Cloud

## Before you start

You need the **admin** role in the Acme Cloud workspace, and permission to
install apps in Microsoft Entra ID. On the Free plan integrations are limited to one; Team
and above are unlimited.

## Steps

1. Settings > **Integrations** and find Microsoft Entra ID.
2. Choose **Connect**. You are redirected to Microsoft Entra ID to authorise access.
...
Escalate if the authorisation redirect returns an error from Microsoft Entra ID, or if the
