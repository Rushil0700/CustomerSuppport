---
id: integration-webhooks-permissions
title: What the Outgoing Webhooks integration can access
category: integrations
tags: [integration, permissions, security, webhooks]
audience: customer
severity: normal
---

# What the Outgoing Webhooks integration can access
...
## Granted to Outgoing Webhooks

Outgoing Webhooks receives access only to the Acme Cloud projects you select during setup.
...
do not copy Outgoing Webhooks content into Acme Cloud beyond what the integration's features
explicitly require, and what is copied is listed on the integration's card.

## Reviewing and revoking

- Settings > Integrations > Outgoing Webhooks shows the scopes in force and who authorised them.
- The audit log records the grant, every scope change, and the revocation.
- Revoking is immediate on our side; also remove the app inside Outgoing Webhooks, since a
