---
id: integration-google-drive-disconnect
title: Disconnect Google Drive and remove its data
category: integrations
tags: [google-drive, integration, privacy, removal]
audience: customer
severity: normal
---

# Disconnect Google Drive and remove its data

## Steps

1. Settings > **Integrations** > Google Drive > **Disconnect**.
2. Confirm. The OAuth token is revoked immediately on our side.
3. Also remove the Acme Cloud app from within Google Drive; revoking on one side alone
