---
id: integration-gitlab-connect
title: Connect GitLab to Acme Cloud
category: integrations
tags: [gitlab, integration, setup]
audience: customer
severity: normal
---

# Connect GitLab to Acme Cloud

## Before you start

You need the **admin** role in the Acme Cloud workspace, and permission to
install apps in GitLab. On the Free plan integrations are limited to one; Team
and above are unlimited.

## Steps

1. Settings > **Integrations** and find GitLab.
2. Choose **Connect**. You are redirected to GitLab to authorise access.
...
Escalate if the authorisation redirect returns an error from GitLab, or if the
