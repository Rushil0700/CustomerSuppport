---
id: troubleshooting-wrong-timezone-macos
title: Timestamps show the wrong time (the macOS desktop app)
category: troubleshooting
tags: [macos, profile, timestamps, timezone]
audience: customer
severity: normal
---

# Timestamps show the wrong time (the macOS desktop app)
