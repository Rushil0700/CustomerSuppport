---
id: integration-asana-limits
title: Asana integration: sync behaviour and limits
category: integrations
tags: [asana, integration, limits, sync]
audience: customer
severity: normal
---

# Asana integration: sync behaviour and limits
...
Asana enforces its own API limits. When we are throttled the integration backs
