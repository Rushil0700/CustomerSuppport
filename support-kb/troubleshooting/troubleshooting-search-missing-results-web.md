---
id: troubleshooting-search-missing-results-web
title: Search does not find a file that exists (the web app)
category: troubleshooting
tags: [files, index, search, web]
audience: customer
severity: normal
---

# Search does not find a file that exists (the web app)
