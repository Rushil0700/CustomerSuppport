---
id: troubleshooting-missing-files-android
title: Files have disappeared (the Android app)
category: troubleshooting
tags: [android, files, missing, recovery, trash]
audience: customer
severity: high
---

# Files have disappeared (the Android app)
