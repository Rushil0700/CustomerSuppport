---
id: integration-quickbooks-limits
title: QuickBooks integration: sync behaviour and limits
category: integrations
tags: [integration, limits, quickbooks, sync]
audience: customer
severity: normal
---

# QuickBooks integration: sync behaviour and limits
...
QuickBooks enforces its own API limits. When we are throttled the integration backs
