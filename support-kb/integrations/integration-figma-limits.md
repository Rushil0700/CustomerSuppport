---
id: integration-figma-limits
title: Figma integration: sync behaviour and limits
category: integrations
tags: [figma, integration, limits, sync]
audience: customer
severity: normal
---

# Figma integration: sync behaviour and limits
...
Figma enforces its own API limits. When we are throttled the integration backs
