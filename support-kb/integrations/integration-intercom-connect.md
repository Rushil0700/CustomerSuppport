---
id: integration-intercom-connect
title: Connect Intercom to Acme Cloud
category: integrations
tags: [integration, intercom, setup]
audience: customer
severity: normal
---

# Connect Intercom to Acme Cloud

## Before you start

You need the **admin** role in the Acme Cloud workspace, and permission to
install apps in Intercom. On the Free plan integrations are limited to one; Team
and above are unlimited.

## Steps

1. Settings > **Integrations** and find Intercom.
2. Choose **Connect**. You are redirected to Intercom to authorise access.
...
Escalate if the authorisation redirect returns an error from Intercom, or if the
