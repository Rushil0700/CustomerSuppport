---
id: account-transfer-ownership-windows
title: Transfer workspace ownership (the Windows desktop app)
category: account
tags: [admin, ownership, windows, workspace]
audience: customer
severity: normal
---

# Transfer workspace ownership (the Windows desktop app)
