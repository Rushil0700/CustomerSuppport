---
id: troubleshooting-selective-sync-confusion-windows
title: Files exist on the web app but not on this device (the Windows desktop app)
category: troubleshooting
tags: [desktop, files, selective-sync, windows]
audience: customer
severity: normal
---

# Files exist on the web app but not on this device (the Windows desktop app)
