---
id: integration-okta-connect
title: Connect Okta to Acme Cloud
category: integrations
tags: [integration, okta, setup]
audience: customer
severity: normal
---

# Connect Okta to Acme Cloud

## Before you start

You need the **admin** role in the Acme Cloud workspace, and permission to
install apps in Okta. On the Free plan integrations are limited to one; Team
and above are unlimited.

## Steps

1. Settings > **Integrations** and find Okta.
2. Choose **Connect**. You are redirected to Okta to authorise access.
...
Escalate if the authorisation redirect returns an error from Okta, or if the
