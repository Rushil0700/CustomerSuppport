---
id: integration-intercom-disconnect
title: Disconnect Intercom and remove its data
category: integrations
tags: [integration, intercom, privacy, removal]
audience: customer
severity: normal
---

# Disconnect Intercom and remove its data

## Steps

1. Settings > **Integrations** > Intercom > **Disconnect**.
2. Confirm. The OAuth token is revoked immediately on our side.
3. Also remove the Acme Cloud app from within Intercom; revoking on one side alone
