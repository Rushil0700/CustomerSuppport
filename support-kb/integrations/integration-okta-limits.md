---
id: integration-okta-limits
title: Okta integration: sync behaviour and limits
category: integrations
tags: [integration, limits, okta, sync]
audience: customer
severity: normal
---

# Okta integration: sync behaviour and limits
...
Okta enforces its own API limits. When we are throttled the integration backs
