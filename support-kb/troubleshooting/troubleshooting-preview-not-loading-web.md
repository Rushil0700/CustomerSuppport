---
id: troubleshooting-preview-not-loading-web
title: A file preview will not load (the web app)
category: troubleshooting
tags: [files, preview, troubleshooting, web]
audience: customer
severity: normal
---

# A file preview will not load (the web app)
