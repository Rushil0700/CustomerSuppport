---
id: integration-trello-limits
title: Trello integration: sync behaviour and limits
category: integrations
tags: [integration, limits, sync, trello]
audience: customer
severity: normal
---

# Trello integration: sync behaviour and limits
...
Trello enforces its own API limits. When we are throttled the integration backs
