---
id: integration-dropbox-limits
title: Dropbox integration: sync behaviour and limits
category: integrations
tags: [dropbox, integration, limits, sync]
audience: customer
severity: normal
---

# Dropbox integration: sync behaviour and limits
...
Dropbox enforces its own API limits. When we are throttled the integration backs
