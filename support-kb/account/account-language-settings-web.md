---
id: account-language-settings-web
title: Change the interface language (the web app)
category: account
tags: [language, localisation, profile, web]
audience: customer
severity: normal
---

# Change the interface language (the web app)
