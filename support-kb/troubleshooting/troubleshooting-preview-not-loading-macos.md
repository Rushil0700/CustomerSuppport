---
id: troubleshooting-preview-not-loading-macos
title: A file preview will not load (the macOS desktop app)
category: troubleshooting
tags: [files, macos, preview, troubleshooting]
audience: customer
severity: normal
---

# A file preview will not load (the macOS desktop app)
