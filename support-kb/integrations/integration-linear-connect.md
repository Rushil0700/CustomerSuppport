---
id: integration-linear-connect
title: Connect Linear to Acme Cloud
category: integrations
tags: [integration, linear, setup]
audience: customer
severity: normal
---

# Connect Linear to Acme Cloud

## Before you start

You need the **admin** role in the Acme Cloud workspace, and permission to
install apps in Linear. On the Free plan integrations are limited to one; Team
and above are unlimited.

## Steps

1. Settings > **Integrations** and find Linear.
2. Choose **Connect**. You are redirected to Linear to authorise access.
...
Escalate if the authorisation redirect returns an error from Linear, or if the
