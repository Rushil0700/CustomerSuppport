---
id: integration-slack-connect
title: Connect Slack to Acme Cloud
category: integrations
tags: [integration, setup, slack]
audience: customer
severity: normal
---

# Connect Slack to Acme Cloud

## Before you start

You need the **admin** role in the Acme Cloud workspace, and permission to
install apps in Slack. On the Free plan integrations are limited to one; Team
and above are unlimited.

## Steps

1. Settings > **Integrations** and find Slack.
2. Choose **Connect**. You are redirected to Slack to authorise access.
...
Escalate if the authorisation redirect returns an error from Slack, or if the
