---
id: account-change-email-ios
title: Change the email address on an account (the iOS app)
category: account
tags: [account, email, ios, profile]
audience: customer
severity: normal
---

# Change the email address on an account (the iOS app)
