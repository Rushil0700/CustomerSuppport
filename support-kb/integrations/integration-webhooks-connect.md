---
id: integration-webhooks-connect
title: Connect Outgoing Webhooks to Acme Cloud
category: integrations
tags: [integration, setup, webhooks]
audience: customer
severity: normal
---

# Connect Outgoing Webhooks to Acme Cloud

## Before you start

You need the **admin** role in the Acme Cloud workspace, and permission to
install apps in Outgoing Webhooks. On the Free plan integrations are limited to one; Team
and above are unlimited.

## Steps

1. Settings > **Integrations** and find Outgoing Webhooks.
2. Choose **Connect**. You are redirected to Outgoing Webhooks to authorise access.
...
Escalate if the authorisation redirect returns an error from Outgoing Webhooks, or if the
