---
id: integration-hubspot-limits
title: HubSpot integration: sync behaviour and limits
category: integrations
tags: [hubspot, integration, limits, sync]
audience: customer
severity: normal
---

# HubSpot integration: sync behaviour and limits
...
HubSpot enforces its own API limits. When we are throttled the integration backs
