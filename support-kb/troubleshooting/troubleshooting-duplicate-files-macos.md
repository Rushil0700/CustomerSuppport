---
id: troubleshooting-duplicate-files-macos
title: Every file appears twice (the macOS desktop app)
category: troubleshooting
tags: [duplicates, import, macos, sync]
audience: customer
severity: normal
---

# Every file appears twice (the macOS desktop app)
