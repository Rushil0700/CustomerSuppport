---
id: integration-dropbox-disconnect
title: Disconnect Dropbox and remove its data
category: integrations
tags: [dropbox, integration, privacy, removal]
audience: customer
severity: normal
---

# Disconnect Dropbox and remove its data

## Steps

1. Settings > **Integrations** > Dropbox > **Disconnect**.
2. Confirm. The OAuth token is revoked immediately on our side.
3. Also remove the Acme Cloud app from within Dropbox; revoking on one side alone
