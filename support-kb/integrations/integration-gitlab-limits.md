---
id: integration-gitlab-limits
title: GitLab integration: sync behaviour and limits
category: integrations
tags: [gitlab, integration, limits, sync]
audience: customer
severity: normal
---

# GitLab integration: sync behaviour and limits
...
GitLab enforces its own API limits. When we are throttled the integration backs
