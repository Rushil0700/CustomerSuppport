---
id: troubleshooting-preview-not-loading-windows
title: A file preview will not load (the Windows desktop app)
category: troubleshooting
tags: [files, preview, troubleshooting, windows]
audience: customer
severity: normal
---

# A file preview will not load (the Windows desktop app)
