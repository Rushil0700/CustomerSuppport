---
id: troubleshooting-missing-files-macos
title: Files have disappeared (the macOS desktop app)
category: troubleshooting
tags: [files, macos, missing, recovery, trash]
audience: customer
severity: high
---

# Files have disappeared (the macOS desktop app)
