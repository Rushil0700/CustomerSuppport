---
id: integration-s3-limits
title: Amazon S3 integration: sync behaviour and limits
category: integrations
tags: [integration, limits, s3, sync]
audience: customer
severity: normal
---

# Amazon S3 integration: sync behaviour and limits
...
Amazon S3 enforces its own API limits. When we are throttled the integration backs
