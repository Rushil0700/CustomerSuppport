---
id: integration-jira-permissions
title: What the Jira integration can access
category: integrations
tags: [integration, jira, permissions, security]
audience: customer
severity: normal
---

# What the Jira integration can access
...
Jira receives access only to the Acme Cloud projects you select during setup.
...
do not copy Jira content into Acme Cloud beyond what the integration's features
explicitly require, and what is copied is listed on the integration's card.

## Reviewing and revoking

- Settings > Integrations > Jira shows the scopes in force and who authorised them.
- The audit log records the grant, every scope change, and the revocation.
- Revoking is immediate on our side; also remove the app inside Jira, since a
