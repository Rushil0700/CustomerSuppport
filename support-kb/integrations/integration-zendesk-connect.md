---
id: integration-zendesk-connect
title: Connect Zendesk to Acme Cloud
category: integrations
tags: [integration, setup, zendesk]
audience: customer
severity: normal
---

# Connect Zendesk to Acme Cloud

## Before you start

You need the **admin** role in the Acme Cloud workspace, and permission to
install apps in Zendesk. On the Free plan integrations are limited to one; Team
and above are unlimited.

## Steps

1. Settings > **Integrations** and find Zendesk.
2. Choose **Connect**. You are redirected to Zendesk to authorise access.
...
Escalate if the authorisation redirect returns an error from Zendesk, or if the
