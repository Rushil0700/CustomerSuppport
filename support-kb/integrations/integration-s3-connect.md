---
id: integration-s3-connect
title: Connect Amazon S3 to Acme Cloud
category: integrations
tags: [integration, s3, setup]
audience: customer
severity: normal
---

# Connect Amazon S3 to Acme Cloud

## Before you start

You need the **admin** role in the Acme Cloud workspace, and permission to
install apps in Amazon S3. On the Free plan integrations are limited to one; Team
and above are unlimited.

## Steps

1. Settings > **Integrations** and find Amazon S3.
2. Choose **Connect**. You are redirected to Amazon S3 to authorise access.
...
Escalate if the authorisation redirect returns an error from Amazon S3, or if the
