---
id: account-enable-mfa-macos
title: Turn on multi-factor authentication (the macOS desktop app)
category: account
tags: [2fa, macos, mfa, security]
audience: customer
severity: normal
---

# Turn on multi-factor authentication (the macOS desktop app)
