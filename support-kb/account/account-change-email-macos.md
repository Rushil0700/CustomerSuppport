---
id: account-change-email-macos
title: Change the email address on an account (the macOS desktop app)
category: account
tags: [account, email, macos, profile]
audience: customer
severity: normal
---

# Change the email address on an account (the macOS desktop app)
