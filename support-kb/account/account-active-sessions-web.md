---
id: account-active-sessions-web
title: Review and end active sessions (the web app)
category: account
tags: [account, security, sessions, web]
audience: customer
severity: high
---

# Review and end active sessions (the web app)
