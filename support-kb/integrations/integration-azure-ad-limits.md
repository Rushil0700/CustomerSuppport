---
id: integration-azure-ad-limits
title: Microsoft Entra ID integration: sync behaviour and limits
category: integrations
tags: [azure-ad, integration, limits, sync]
audience: customer
severity: normal
---

# Microsoft Entra ID integration: sync behaviour and limits
...
Microsoft Entra ID enforces its own API limits. When we are throttled the integration backs
