---
id: account-active-sessions-macos
title: Review and end active sessions (the macOS desktop app)
category: account
tags: [account, macos, security, sessions]
audience: customer
severity: high
---

# Review and end active sessions (the macOS desktop app)
