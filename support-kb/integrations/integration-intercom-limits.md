---
id: integration-intercom-limits
title: Intercom integration: sync behaviour and limits
category: integrations
tags: [integration, intercom, limits, sync]
audience: customer
severity: normal
---

# Intercom integration: sync behaviour and limits
...
Intercom enforces its own API limits. When we are throttled the integration backs
