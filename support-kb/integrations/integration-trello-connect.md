---
id: integration-trello-connect
title: Connect Trello to Acme Cloud
category: integrations
tags: [integration, setup, trello]
audience: customer
severity: normal
---

# Connect Trello to Acme Cloud

## Before you start

You need the **admin** role in the Acme Cloud workspace, and permission to
install apps in Trello. On the Free plan integrations are limited to one; Team
and above are unlimited.

## Steps

1. Settings > **Integrations** and find Trello.
2. Choose **Connect**. You are redirected to Trello to authorise access.
...
Escalate if the authorisation redirect returns an error from Trello, or if the
