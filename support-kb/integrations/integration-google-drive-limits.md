---
id: integration-google-drive-limits
title: Google Drive integration: sync behaviour and limits
category: integrations
tags: [google-drive, integration, limits, sync]
audience: customer
severity: normal
---

# Google Drive integration: sync behaviour and limits
...
Google Drive enforces its own API limits. When we are throttled the integration backs
