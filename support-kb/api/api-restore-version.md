---
id: api-restore-version
title: API: Restore a file version
category: api
...
# API: Restore a file version

```
POST https://api.acme.example/v1/files/{id}/versions/{version}/restore
```
...
```bash
curl -X POST "https://api.acme.example/v1/files/{id}/versions/{version}/restore" \
