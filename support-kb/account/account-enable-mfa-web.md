---
id: account-enable-mfa-web
title: Turn on multi-factor authentication (the web app)
category: account
tags: [2fa, mfa, security, web]
audience: customer
severity: normal
---

# Turn on multi-factor authentication (the web app)
