...
# API: List file versions

```
GET https://api.acme.example/v1/files/{id}/versions
```
...
```bash
curl -X GET "https://api.acme.example/v1/files/{id}/versions" \
