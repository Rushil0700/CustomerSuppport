---
id: troubleshooting-cannot-delete-file-windows
title: A file will not delete (the Windows desktop app)
category: troubleshooting
tags: [delete, files, locks, windows]
audience: customer
severity: normal
---

# A file will not delete (the Windows desktop app)
