...
title: Connect HubSpot to Acme Cloud
category: integrations
tags: [hubspot, integration, setup]
audience: customer
severity: normal
---

# Connect HubSpot to Acme Cloud

## Before you start

You need the **admin** role in the Acme Cloud workspace, and permission to
install apps in HubSpot. On the Free plan integrations are limited to one; Team
and above are unlimited.

## Steps

1. Settings > **Integrations** and find HubSpot.
2. Choose **Connect**. You are redirected to HubSpot to authorise access.
...
Escalate if the authorisation redirect returns an error from HubSpot, or if the
