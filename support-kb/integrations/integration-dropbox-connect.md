---
id: integration-dropbox-connect
title: Connect Dropbox to Acme Cloud
category: integrations
tags: [dropbox, integration, setup]
audience: customer
severity: normal
---

# Connect Dropbox to Acme Cloud

## Before you start

You need the **admin** role in the Acme Cloud workspace, and permission to
install apps in Dropbox. On the Free plan integrations are limited to one; Team
and above are unlimited.

## Steps

1. Settings > **Integrations** and find Dropbox.
2. Choose **Connect**. You are redirected to Dropbox to authorise access.
...
Escalate if the authorisation redirect returns an error from Dropbox, or if the
