---
id: integration-zoom-limits
title: Zoom integration: sync behaviour and limits
category: integrations
tags: [integration, limits, sync, zoom]
audience: customer
severity: normal
---

# Zoom integration: sync behaviour and limits
...
Zoom enforces its own API limits. When we are throttled the integration backs
