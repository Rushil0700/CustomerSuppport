---
id: account-invite-not-received-ios
title: An invitation email never arrived (the iOS app)
category: account
tags: [email, invite, ios, members]
audience: customer
severity: normal
---

# An invitation email never arrived (the iOS app)
