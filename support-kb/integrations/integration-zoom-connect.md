---
id: integration-zoom-connect
title: Connect Zoom to Acme Cloud
category: integrations
tags: [integration, setup, zoom]
audience: customer
severity: normal
---

# Connect Zoom to Acme Cloud

## Before you start

You need the **admin** role in the Acme Cloud workspace, and permission to
install apps in Zoom. On the Free plan integrations are limited to one; Team
and above are unlimited.

## Steps

1. Settings > **Integrations** and find Zoom.
2. Choose **Connect**. You are redirected to Zoom to authorise access.
...
Escalate if the authorisation redirect returns an error from Zoom, or if the
