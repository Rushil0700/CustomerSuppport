---
id: account-language-settings-windows
title: Change the interface language (the Windows desktop app)
category: account
tags: [language, localisation, profile, windows]
audience: customer
severity: normal
---

# Change the interface language (the Windows desktop app)
