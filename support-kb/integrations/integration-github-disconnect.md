---
id: integration-github-disconnect
title: Disconnect GitHub and remove its data
category: integrations
tags: [github, integration, privacy, removal]
audience: customer
severity: normal
---

# Disconnect GitHub and remove its data

## Steps

1. Settings > **Integrations** > GitHub > **Disconnect**.
2. Confirm. The OAuth token is revoked immediately on our side.
3. Also remove the Acme Cloud app from within GitHub; revoking on one side alone
