---
id: integration-notion-limits
title: Notion integration: sync behaviour and limits
category: integrations
tags: [integration, limits, notion, sync]
audience: customer
severity: normal
---

# Notion integration: sync behaviour and limits
...
Notion enforces its own API limits. When we are throttled the integration backs
