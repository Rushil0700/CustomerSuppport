---
id: mobile-mobile-storage-android
title: The mobile app is using too much device storage (the Android app)
category: mobile
tags: [android, cache, mobile, storage]
audience: customer
severity: normal
---

# The mobile app is using too much device storage (the Android app)
