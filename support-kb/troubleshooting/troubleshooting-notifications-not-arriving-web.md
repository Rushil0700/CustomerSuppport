---
id: troubleshooting-notifications-not-arriving-web
title: Notifications are not arriving (the web app)
category: troubleshooting
tags: [email, notifications, push, web]
audience: customer
severity: normal
---

# Notifications are not arriving (the web app)
