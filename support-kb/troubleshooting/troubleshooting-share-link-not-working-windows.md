---
id: troubleshooting-share-link-not-working-windows
title: A share link shows 'not available' (the Windows desktop app)
category: troubleshooting
tags: [link, permissions, share, windows]
audience: customer
severity: normal
---

# A share link shows 'not available' (the Windows desktop app)
