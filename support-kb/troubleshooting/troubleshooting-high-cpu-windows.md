---
id: troubleshooting-high-cpu-windows
title: The app uses a lot of CPU or battery (the Windows desktop app)
category: troubleshooting
tags: [battery, cpu, performance, windows]
audience: customer
severity: normal
---

# The app uses a lot of CPU or battery (the Windows desktop app)
