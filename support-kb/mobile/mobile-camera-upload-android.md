---
id: mobile-camera-upload-android
title: Set up automatic camera upload (the Android app)
category: mobile
tags: [android, backup, mobile, photos]
audience: customer
severity: normal
---

# Set up automatic camera upload (the Android app)
