---
id: integration-github-limits
title: GitHub integration: sync behaviour and limits
category: integrations
tags: [github, integration, limits, sync]
audience: customer
severity: normal
---

# GitHub integration: sync behaviour and limits
...
GitHub enforces its own API limits. When we are throttled the integration backs
