---
id: integration-asana-disconnect
title: Disconnect Asana and remove its data
category: integrations
tags: [asana, integration, privacy, removal]
audience: customer
severity: normal
---

# Disconnect Asana and remove its data

## Steps

1. Settings > **Integrations** > Asana > **Disconnect**.
2. Confirm. The OAuth token is revoked immediately on our side.
3. Also remove the Acme Cloud app from within Asana; revoking on one side alone
