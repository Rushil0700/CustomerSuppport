---
id: troubleshooting-upload-fails-ios
title: Uploads fail part-way through (the iOS app)
category: troubleshooting
tags: [files, ios, network, upload]
audience: customer
severity: normal
---

# Uploads fail part-way through (the iOS app)
