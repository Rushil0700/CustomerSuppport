---
id: troubleshooting-upload-fails-windows
title: Uploads fail part-way through (the Windows desktop app)
category: troubleshooting
tags: [files, network, upload, windows]
audience: customer
severity: normal
---

# Uploads fail part-way through (the Windows desktop app)
