---
id: integration-notion-connect
title: Connect Notion to Acme Cloud
category: integrations
tags: [integration, notion, setup]
audience: customer
severity: normal
---

# Connect Notion to Acme Cloud

## Before you start

You need the **admin** role in the Acme Cloud workspace, and permission to
install apps in Notion. On the Free plan integrations are limited to one; Team
and above are unlimited.

## Steps

1. Settings > **Integrations** and find Notion.
2. Choose **Connect**. You are redirected to Notion to authorise access.
...
Escalate if the authorisation redirect returns an error from Notion, or if the
