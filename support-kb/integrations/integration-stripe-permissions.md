---
id: integration-stripe-permissions
title: What the Stripe integration can access
category: integrations
tags: [integration, permissions, security, stripe]
audience: customer
severity: normal
---

# What the Stripe integration can access
...
Stripe receives access only to the Acme Cloud projects you select during setup.
...
do not copy Stripe content into Acme Cloud beyond what the integration's features
explicitly require, and what is copied is listed on the integration's card.

## Reviewing and revoking

- Settings > Integrations > Stripe shows the scopes in force and who authorised them.
- The audit log records the grant, every scope change, and the revocation.
- Revoking is immediate on our side; also remove the app inside Stripe, since a
