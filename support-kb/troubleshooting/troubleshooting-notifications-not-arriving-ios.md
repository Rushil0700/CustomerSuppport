---
id: troubleshooting-notifications-not-arriving-ios
title: Notifications are not arriving (the iOS app)
category: troubleshooting
tags: [email, ios, notifications, push]
audience: customer
severity: normal
---

# Notifications are not arriving (the iOS app)
