---
id: account-notification-digest-ios
title: Reduce notification volume (the iOS app)
category: account
tags: [email, ios, notifications, preferences]
audience: customer
severity: normal
---

# Reduce notification volume (the iOS app)
