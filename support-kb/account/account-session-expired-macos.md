---
id: account-session-expired-macos
title: Signed out repeatedly during the day (the macOS desktop app)
category: account
tags: [cookies, login, macos, session]
audience: customer
severity: normal
---

# Signed out repeatedly during the day (the macOS desktop app)
