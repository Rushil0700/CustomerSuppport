---
id: troubleshooting-file-conflict-windows
title: Conflicted copies keep appearing (the Windows desktop app)
category: troubleshooting
tags: [conflict, files, sync, windows]
audience: customer
severity: normal
---

# Conflicted copies keep appearing (the Windows desktop app)
