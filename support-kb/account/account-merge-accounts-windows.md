---
id: account-merge-accounts-windows
title: Merge two accounts (the Windows desktop app)
category: account
tags: [account, duplicate, merge, windows]
audience: customer
severity: normal
---

# Merge two accounts (the Windows desktop app)
