---
id: integration-microsoft-teams-limits
title: Microsoft Teams integration: sync behaviour and limits
category: integrations
tags: [integration, limits, microsoft-teams, sync]
audience: customer
severity: normal
---

# Microsoft Teams integration: sync behaviour and limits
...
Microsoft Teams enforces its own API limits. When we are throttled the integration backs
