...
title: Connect GitHub to Acme Cloud
...
# Connect GitHub to Acme Cloud

## Before you start

You need the **admin** role in the Acme Cloud workspace, and permission to
install apps in GitHub. On the Free plan integrations are limited to one; Team
and above are unlimited.

## Steps

1. Settings > **Integrations** and find GitHub.
2. Choose **Connect**. You are redirected to GitHub to authorise access.
...
Escalate if the authorisation redirect returns an error from GitHub, or if the
