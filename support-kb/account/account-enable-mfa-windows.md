---
id: account-enable-mfa-windows
title: Turn on multi-factor authentication (the Windows desktop app)
category: account
tags: [2fa, mfa, security, windows]
audience: customer
severity: normal
---

# Turn on multi-factor authentication (the Windows desktop app)
