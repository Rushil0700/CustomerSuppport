---
id: integration-salesforce-limits
title: Salesforce integration: sync behaviour and limits
category: integrations
tags: [integration, limits, salesforce, sync]
audience: customer
severity: normal
---

# Salesforce integration: sync behaviour and limits
...
Salesforce enforces its own API limits. When we are throttled the integration backs
