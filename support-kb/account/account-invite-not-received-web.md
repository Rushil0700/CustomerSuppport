---
id: account-invite-not-received-web
title: An invitation email never arrived (the web app)
category: account
tags: [email, invite, members, web]
audience: customer
severity: normal
---

# An invitation email never arrived (the web app)
