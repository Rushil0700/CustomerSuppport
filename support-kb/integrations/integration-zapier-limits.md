---
id: integration-zapier-limits
title: Zapier integration: sync behaviour and limits
category: integrations
tags: [integration, limits, sync, zapier]
audience: customer
severity: normal
---

# Zapier integration: sync behaviour and limits
...
Zapier enforces its own API limits. When we are throttled the integration backs
