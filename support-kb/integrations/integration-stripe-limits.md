---
id: integration-stripe-limits
title: Stripe integration: sync behaviour and limits
category: integrations
tags: [integration, limits, stripe, sync]
audience: customer
severity: normal
---

# Stripe integration: sync behaviour and limits
...
Stripe enforces its own API limits. When we are throttled the integration backs
