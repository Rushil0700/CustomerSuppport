---
id: integration-zapier-connect
title: Connect Zapier to Acme Cloud
category: integrations
tags: [integration, setup, zapier]
audience: customer
severity: normal
---

# Connect Zapier to Acme Cloud

## Before you start

You need the **admin** role in the Acme Cloud workspace, and permission to
install apps in Zapier. On the Free plan integrations are limited to one; Team
and above are unlimited.

## Steps

1. Settings > **Integrations** and find Zapier.
2. Choose **Connect**. You are redirected to Zapier to authorise access.
...
Escalate if the authorisation redirect returns an error from Zapier, or if the
