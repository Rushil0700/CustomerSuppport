---
id: integration-linear-limits
title: Linear integration: sync behaviour and limits
category: integrations
tags: [integration, limits, linear, sync]
audience: customer
severity: normal
---

# Linear integration: sync behaviour and limits
...
Linear enforces its own API limits. When we are throttled the integration backs
