---
id: integration-google-workspace-permissions
title: What the Google Workspace integration can access
category: integrations
tags: [google-workspace, integration, permissions, security]
audience: customer
severity: normal
---

# What the Google Workspace integration can access
...
## Granted to Google Workspace

Google Workspace receives access only to the Acme Cloud projects you select during setup.
...
do not copy Google Workspace content into Acme Cloud beyond what the integration's features
explicitly require, and what is copied is listed on the integration's card.

## Reviewing and revoking

- Settings > Integrations > Google Workspace shows the scopes in force and who authorised them.
- The audit log records the grant, every scope change, and the revocation.
- Revoking is immediate on our side; also remove the app inside Google Workspace, since a
