---
id: troubleshooting-cannot-delete-file-android
title: A file will not delete (the Android app)
category: troubleshooting
tags: [android, delete, files, locks]
audience: customer
severity: normal
---

# A file will not delete (the Android app)
