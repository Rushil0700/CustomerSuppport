---
id: troubleshooting-proxy-blocking-windows
title: The app cannot reach the service on a corporate network (the Windows desktop app)
category: troubleshooting
tags: [enterprise, firewall, network, proxy, windows]
audience: customer
severity: normal
---

# The app cannot reach the service on a corporate network (the Windows desktop app)
