---
id: troubleshooting-share-link-not-working-macos
title: A share link shows 'not available' (the macOS desktop app)
category: troubleshooting
tags: [link, macos, permissions, share]
audience: customer
severity: normal
---

# A share link shows 'not available' (the macOS desktop app)
