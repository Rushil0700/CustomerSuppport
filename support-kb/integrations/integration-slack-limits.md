---
id: integration-slack-limits
title: Slack integration: sync behaviour and limits
category: integrations
tags: [integration, limits, slack, sync]
audience: customer
severity: normal
---

# Slack integration: sync behaviour and limits
...
Slack enforces its own API limits. When we are throttled the integration backs
