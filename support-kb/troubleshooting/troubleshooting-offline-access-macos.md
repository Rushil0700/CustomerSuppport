---
id: troubleshooting-offline-access-macos
title: Access files without a connection (the macOS desktop app)
category: troubleshooting
tags: [macos, mobile, offline, sync]
audience: customer
severity: normal
---

# Access files without a connection (the macOS desktop app)
