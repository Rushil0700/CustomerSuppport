---
id: account-invite-not-received-macos
title: An invitation email never arrived (the macOS desktop app)
category: account
tags: [email, invite, macos, members]
audience: customer
severity: normal
---

# An invitation email never arrived (the macOS desktop app)
