---
id: api-verify-webhook
title: API: Verify a webhook signature
category: api
tags: [api, reference, verify]
audience: customer
severity: normal
---

# API: Verify a webhook signature

```
POST https://api.acme.example/v1/webhooks/{id}/test
```
...
```bash
curl -X POST "https://api.acme.example/v1/webhooks/{id}/test" \
