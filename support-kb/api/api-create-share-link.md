...
```
POST https://api.acme.example/v1/files/{id}/links
```

**Required scope:** `files:share`
...
```bash
curl -X POST "https://api.acme.example/v1/files/{id}/links" \
