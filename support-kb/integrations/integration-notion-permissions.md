---
id: integration-notion-permissions
title: What the Notion integration can access
category: integrations
tags: [integration, notion, permissions, security]
audience: customer
severity: normal
---

# What the Notion integration can access
...
Notion receives access only to the Acme Cloud projects you select during setup.
...
do not copy Notion content into Acme Cloud beyond what the integration's features
explicitly require, and what is copied is listed on the integration's card.

## Reviewing and revoking

- Settings > Integrations > Notion shows the scopes in force and who authorised them.
- The audit log records the grant, every scope change, and the revocation.
- Revoking is immediate on our side; also remove the app inside Notion, since a
