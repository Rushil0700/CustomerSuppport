---
id: account-session-expired-android
title: Signed out repeatedly during the day (the Android app)
category: account
tags: [android, cookies, login, session]
audience: customer
severity: normal
---

# Signed out repeatedly during the day (the Android app)
