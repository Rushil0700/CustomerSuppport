---
id: integration-salesforce-connect
title: Connect Salesforce to Acme Cloud
category: integrations
tags: [integration, salesforce, setup]
audience: customer
severity: normal
---

# Connect Salesforce to Acme Cloud

## Before you start

You need the **admin** role in the Acme Cloud workspace, and permission to
install apps in Salesforce. On the Free plan integrations are limited to one; Team
and above are unlimited.

## Steps

1. Settings > **Integrations** and find Salesforce.
2. Choose **Connect**. You are redirected to Salesforce to authorise access.
...
Escalate if the authorisation redirect returns an error from Salesforce, or if the
