---
id: integration-zendesk-limits
title: Zendesk integration: sync behaviour and limits
category: integrations
tags: [integration, limits, sync, zendesk]
audience: customer
severity: normal
---

# Zendesk integration: sync behaviour and limits
...
Zendesk enforces its own API limits. When we are throttled the integration backs
