---
id: troubleshooting-search-missing-results-windows
title: Search does not find a file that exists (the Windows desktop app)
category: troubleshooting
tags: [files, index, search, windows]
audience: customer
severity: normal
---

# Search does not find a file that exists (the Windows desktop app)
