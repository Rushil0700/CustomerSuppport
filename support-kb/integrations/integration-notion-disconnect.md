---
id: integration-notion-disconnect
title: Disconnect Notion and remove its data
category: integrations
tags: [integration, notion, privacy, removal]
audience: customer
severity: normal
---

# Disconnect Notion and remove its data

## Steps

1. Settings > **Integrations** > Notion > **Disconnect**.
2. Confirm. The OAuth token is revoked immediately on our side.
3. Also remove the Acme Cloud app from within Notion; revoking on one side alone
